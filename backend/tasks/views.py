        ...
        if old_status != task.status:
            ...
            Activity.objects.create(
                ...
                message=(
                    f"Moved task "
                    f"'{task.title}' "
                    f"to {status_names.get(task.status, task.status)}"
                )
    )
        else:
            Activity.objects.create(
...
class StopTimerView(
    ...
    def post(self, request, *args, **kwargs):
        ...
        session.duration_hours = Decimal(
